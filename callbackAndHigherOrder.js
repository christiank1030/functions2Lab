...
let multiply = (num1, num2, callbackFunction) => {
  let numProduct = num1 * num2

  return callbackFunction(numProduct)
}
...
let first = (array, callbackFunction) => {
  let firstElement = array[0]

  return callbackFunction(firstElement)
}
...
let last = (array, callbackFunction) => {
  ...
  return callbackFunction(lastElement)
}
...
let contains = (array, nameParam, callbackFunction) => {
  return callbackFunction(array.includes(nameParam))
}
...
// CODE HERE 
/*
let each = (array, callbackFunction) => {
...
let getUserById = (usersArray, id, callbackFunction) => {
  for(i = 0; i < usersArray.length; i++) {
    if(usersArray[i].id === id) {
      return callbackFunction(usersArray[i])
    }
  }
}
